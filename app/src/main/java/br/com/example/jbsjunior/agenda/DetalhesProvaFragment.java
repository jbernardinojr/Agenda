...
public class DetalhesProvaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        campoMateria = (TextView) view.findViewById(R.id.tv_detalhes_prova_materia);
        campoData = (TextView) view.findViewById(R.id.tv_detalhes_prova_data);
        listaTopicos = (ListView) view.findViewById(R.id.lv_detalhes_prova_topicos);

        Bundle parametros = getArguments();

        if (parametros!=null) {
            Prova prova = parametros.getParcelable("prova");
            populaCampo(prova);
        }
    ...
    public void populaCampo(Prova prova){
